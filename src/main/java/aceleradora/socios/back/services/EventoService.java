...
//        Long totalEventos = result.getValue();
    ...
    public Evento mapEventoPostToEvento(EventoPostDTO eventoDTO){
        ...
        if(eventoDTO.getLugar() != null) {
            evento.setLugar(modelMapper.map(eventoDTO.getLugar(), Ubicacion.class));
        } else {
    ...
    public EventoDTO mapEventoToEventoDTO(Evento evento) {
        ...
        if(evento.getLugar() != null) {
            eventoDTO.setLugar(modelMapper.map(evento.getLugar(), UbicacionDTO.class));
        } else {
            eventoDTO.setLugar(null);
        }
