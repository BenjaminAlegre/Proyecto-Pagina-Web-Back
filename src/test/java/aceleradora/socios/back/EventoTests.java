...
public class EventoTests {
    ...
    public void altaEventoTest(){
        ...
        Assertions.assertEquals(evento.getLugar().getDireccion(), listaDeEventos2.get(listaDeEventos2.size()-1).getLugar().getDireccion());
        Assertions.assertEquals(evento.getLugar().getPiso(), listaDeEventos2.get(listaDeEventos2.size()-1).getLugar().getPiso());
        Assertions.assertEquals(evento.getLugar().getLocalidad(), listaDeEventos2.get(listaDeEventos2.size()-1).getLugar().getLocalidad());
        Assertions.assertEquals(evento.getLugar().getProvincia(), listaDeEventos2.get(listaDeEventos2.size()-1).getLugar().getProvincia());
    ...
    public void editarEventoTest(){
        ...
        eventoEditado.setLugar(ubicacionEventoModificado3);
